...
To examine potential differences in inter-trial phase coherence (ITPC) across experimental conditions, we used a bayes an RBA  package which allow to quantify the difference.
