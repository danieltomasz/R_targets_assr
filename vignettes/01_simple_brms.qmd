...
#| message: false
#| warning: false
#| fig-cap: "Distribution of the evoked changed in ITPC by sound stimulation (STIM vs PRESTIM)"
#| column: page         # span full page width (HTML)
#| fig-width: 16        # inches on the graphics device
#| fig-height: 8        # adjust to keep aspect you like
#| fig-dpi: 200         # crisper lines when wider
...
Now I want to run model via targets

Now I want to  extract the ITPC data and visualise it across the scalp 
